...
| **Storage** | The disk deep-dive: capacity with a growth projection ("full in ~N weeks"), RAID array health in plain language, **live per-disk I/O graphs**, and per-drive SMART with temperature/wear **trend charts** from daily samples kept in SQLite. |
