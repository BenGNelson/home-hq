...
| **Weather** | Current conditions (temp, feels-like, humidity, wind, with day/night condition icons) + a **5-day forecast** (hi/lo + precipitation chance), from **Open-Meteo** — free, no API key. Hides itself until a location is configured. |
