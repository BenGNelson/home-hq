...
| **Printer** | Live 3D-printer telemetry (Bambu Lab over local MQTT, LAN-only) — print state, progress, layer count, time remaining, nozzle/bed/chamber temps, and AMS filament. Optional; the module hides itself until a printer is configured. |
