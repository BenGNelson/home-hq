...
| Module | What you get |
|---|---|
| **Dashboard** | At-a-glance widgets: CPU/RAM/uptime (plus GPU load/VRAM/encode sessions when an NVIDIA card is present), storage usage, RAID health, per-drive SMART, running containers, Plex now-playing + recently-added. |
