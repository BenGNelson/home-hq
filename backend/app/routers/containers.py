...
(an accidentally-logged secret, or activity like transfer names). This is an
...
EXCLUDE lists containers whose logs are withheld (e.g. a VPN or transfer client —
...
def get_container_logs(name: str, tail: int = _LOGS_TAIL_DEFAULT):
    ...
    withheld (see the module docstring) — sensitive ones like a VPN/transfer
